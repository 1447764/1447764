...
> - **개발 기간:** 202X.XX ~ 202X.XX (2개월)
> - **한 줄 설명:** 좀비 아포칼립스 세계관을 배경으로 하는 3인칭 슈팅(TPS) 게임입니다.
> - **주요 역할 및 구현 내용:**
>   - 게임플레이 어빌리티 시스템(GAS)을 활용한 캐릭터 스킬 및 상태 관리
>   - C++ 기반의 무기 시스템(발사, 재장전, 교체) 및 인벤토리 구현
>   - 블루프린트를 활용하여 레벨 디자인 및 AI 행동 트리(Behavior Tree) 프로토타이핑
> - **사용 기술:** `Unreal Engine`, `C++`, `Blueprint`, `GAS`
